...
class TrainDP3Workspace:
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # load mimicgen config
        with open(cfg.task.mg_config, "r") as f:
            ext_cfg = json.load(f)
            # config generator from robomimic generates this part of config unused by MimicGen
            if "meta" in ext_cfg:
                del ext_cfg["meta"]
        self.mg_config = ext_cfg  # config_factory(ext_cfg["name"], config_type=ext_cfg["type"])
    ...
    def eval_datasets(self):
        ...
        dataset_dir = dataset_cfg.root_dir
        ...
        class DedoDataset(data.Dataset):
            ...
            def __getitem__(self, index):
                ...
                # print(f"{self.dir}/demo_{index}.npz")
                return demo

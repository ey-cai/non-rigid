...
@hydra.main(
    version_base=None,
    config_path='/home/yingyuan/non-rigid/third_party/3D-Diffusion-Policy/3D-Diffusion-Policy/diffusion_policy_3d/config'  # str(pathlib.Path(__file__).parent.parent.parent.joinpath(
